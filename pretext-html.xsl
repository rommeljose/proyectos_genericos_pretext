            ...
            <div class="ptx-page">
                ...
                <main class="ptx-main">
                    ...
                    <div class="ptx-content-footer">
                        ...
                        <a class="top-button button" href="#" title="Arriba">
                            <span class="icon">^</span>
                            <span class="name">Arrb.</span>
                        </a> 
...
<xsl:template name="runestone-link">
    <a class="runestone-link" href="https://tecnologiacumanesa.blogspot.com/" title="Blog de Ciencia, Tecnología e Historia">
        <img class="logo" src="https://lh4.googleusercontent.com/-sMHwPvQ6ZZM/UHpJJp1LMgI/AAAAAAAABmM/apKY4wuczr8/s800/que_puede_hacer_un_fisico_trasparente.png"/>
    </a>
</xsl:template>
    ...
    <xsl:if test="$has-native-search">
        <div class="searchbox">
            <div class="searchwidget">
                <input id="ptxsearch" class="ptxsearch" type="text" name="terms" placeholder="Búsqueda" onchange="doSearch()" /> <!--Modificado por RJCG-->
